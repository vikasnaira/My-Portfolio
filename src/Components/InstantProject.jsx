  ...
  return (
    <article className=' hidden md:flex flex-col justify-center items-center gap-5 mt-10 relative w-full'>
      <motion.h1 
        ...
        className="text-4xl text-center font-bold mt-10 vk overflow-hidden text-[#7AF298]">INSTANT PROJECTS <br /> OVERVIEW</motion.h1>
      ...
      <div className="projectGrid z-2 columns-1 sm:columns-2 md:columns-2 lg:columns-4 md:p-20 p-10 max-w-7xl w-full mx-auto ">
        ...
        viewport={{ once:false}}
        transition={{ duration: 0.5 }}
        src="./Photos/Login.jpg" alt="" className='w-full   border-4 border-white/20    hover:scale-103  transition-all duration-300 object-cover rounded-lg mb-4 break-inside-avoid block '/>
        <motion.img 
        initial={{  opacity: 0, scale:0.8, y:40, }}
        whileInView={{  opacity: 1 , scale:1 ,y:0 , }}
        viewport={{ once:false}}
        ...
        viewport={{ once:false}}
        transition={{ duration: 0.5 }}
        src="./Photos/Miranda.jpg" alt="" className='w-full h-50     border-4 border-white/20      hover:scale-103  transition-all duration-300  object-cover rounded-lg mb-4 break-inside-avoid block'/>
        ...
        viewport={{ once:false}}
        transition={{ duration: 0.5 }}
        src="./Photos/Task.webp" alt="" className='w-full  border-4 border-white/20       hover:scale-103  transition-all duration-300  h-auto object-cover rounded-lg mb-4 break-inside-avoid block'/>
        ...
        viewport={{ once:false}}
        transition={{ duration: 0.5 }}
        src="./Photos/Zentry.jpg" alt="" className='   border-4 border-white/20       hover:scale-103  transition-all duration-300  h-95 object-cover rounded-lg mb-4 break-inside-avoid block'/>
