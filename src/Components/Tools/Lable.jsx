...
const Label = ({ baseItems = [] , className = "" , text = "" }) => {
  ...
  return (
    ...
    transition={{ duration: 0.5, delay:0.3, }}
      ...
      className={` ${className} w-full border-y-2 mt-20 border-black py-6 z-1 overflow-y-hidden bg-[#7AF298] overflow-x-hidden cursor-pointer select-none relative flex items-center shadow-[0_4px_20px_rgba(122,242,152,0.2)]`}
    >
        <motion.div
          style={{ x: smoothX }}
