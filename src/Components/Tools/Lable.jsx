...
const Lable = () => {
  ...
  return (
    <div 
      ...
      className='w-full border-y-2 border-black py-6 bg-[#7AF298] overflow-hidden cursor-pointer select-none relative flex items-center shadow-[0_4px_20px_rgba(122,242,152,0.2)]'
    >
        <motion.div
          style={{ x: smoothX }}
