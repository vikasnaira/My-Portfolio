...
const Social = () => {
  return (
    <article className="relative flex flex-col  items-center md:items-start w-full md:w-fit">
        <h1 className='text-3xl text-[#7AF298] font-bold w-fit bg-black' >Social Links</h1>
        <div className="flex  justify-between md:justify-center md:w-fit w-full p-4 items-center md:items-start md:gap-15">
