  ...
  return (
    <article className='mt-10 md:mt-20  relative'>
      ...
      <div className='flex  flex-col items-center text-md  font-black text-white  z-2 '>
        ...
        className='md:text-xl text-sm font-extralight'/>start </>} 
        ...
        items-center   md:h-30 md:-translate-y-48 md:translate-x-70
         ...
         bg-[#7AF298] gap-2 md:px-6 vk px-3 py-2 mt-10 md:mt-0
         "/>
      </div>
      ...
      <section className=' p-3 overflow-visible'>
       <Lable baseItems={techItems} className="bg-gray-900 -rotate-6 border-white text-white h-10" text="vk  text-white md:text-2xl"  />
      </section>
